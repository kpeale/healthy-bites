...
const Cards = () => {
  return (
    <div className='grid grid-cols-1 mt-3 xl:mt-5 pt-5 xl:pt-[5rem] sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 h-auto place-items-center gap-6 bg-gray-400'>
      {/* first card */}
